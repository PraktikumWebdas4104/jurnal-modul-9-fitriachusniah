...
class database{
	...
	function input($nama,$alamat,$usia){
		...
		mysqli_query($this->con,"INSERT INTO user VALUES('$id','$nama','$alamat','$usia')");
	}
	...
	function update($id,$nama,$alamat,$usia){
		...
		mysqli_query($this->con,"UPDATE user SET ID='$id',Nama = '$nama',Alamat = '$alamat',Usia = '$usia' WHERE ID = '$id'");
